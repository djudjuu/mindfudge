...
/// - cutted away unnecessary functions
contract mindfudge03 {
...
///function to place ether as bet
  ...
  **/
  ...
  /// 2do: to be actually a secret, playing cards needs to be
  /// done in a 2stepstyle, first hash of the card, then reveal
